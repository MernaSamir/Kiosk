...
import { get, isEqual, set, pick, mapValues, isEmpty, merge } from 'lodash'
...
class TableMultiCols extends Component {
    ...
    render() {
        const { select, mainKey,cols, header, mainHeader, total_cols={}, fields, labels={}} = this.props;
        if(!select || mainKey){
            return (
...
export const TableMultiCol = connect(mapStateToProps, mapDispatchToProps, null, {pure: false})(TableMultiCols)
