...
export const report_business_day = (params, bd_data, state, props)=>{
    ...
    let data = {
        ...
        sales: {
            ...
            get net(){return this.item-this.discount},
            services: sumBy(paid_receipt, 'service'),
            get gross(){return this.net+this.services},
            get grand(){return this.gross+this.item_tax},
        },
        payment: {
            ...
            ...map(state.settings__mode.data, d => {
                ...
                return {
                    ...
                    value: {
                        ...
                        get item_sales(){return this.gross_sales - sumBy(receipts, 'service')},
                    }
                }
            }).reduce((o, v) => ({ ...o, [v.key]: v.value }), {})
        }
...
export const report_pm = (params, bd_data, state, props) => {
    ...
    let data = {
            ...
            get cats() {return this.cats_list.reduce((o, v)=>({...o, [v.cat]: v}), {})},
            get menu_list(){
            ...
            get menus() {return this.menu_list.reduce((o, v)=>({...o, [v.menu]: v}), {})},
            get dep_list(){
            ...
            get deps() {return this.dep_list.reduce((o, v)=>({...o, [v.dep]: v}), {})},
        }
        return data
}